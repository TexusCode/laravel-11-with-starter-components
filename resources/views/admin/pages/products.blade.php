                    ...
                    <tr>
                        ...
                        <td class="size-px whitespace-nowrap">
                            <div class="px-6 py-1.5 flex justify-end gap-4">
                                ...
                                <a href="{{ route('add-product',$product->id) }}" class="text-green-20">
                                ...
                                <form action="{{ route('delete-product-post',$product->id) }}" method="POST">
                                    @csrf
                                    <button type="submit"
                                        class="inline-flex items-center text-sm font-medium text-red-500 gap-x-1 decoration-2 hover:underline focus:outline-none focus:underline">
