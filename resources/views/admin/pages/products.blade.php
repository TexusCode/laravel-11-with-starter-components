        ...
        <div class="-m-1.5 overflow-hidden">
            <div class="p-1.5 w-full inline-block align-middle">
                <div class="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
                    ...
                    <div class="px-6 py-4 gap-3 flex justify-between items-center border-b border-gray-200">
                        ...
                        <div>
                            <div class="inline-flex gap-x-2">
                                <a class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-green-20 text-white hover:bg-green-10 focus:outline-none focus:bg-green-30 disabled:opacity-50 disabled:pointer-events-none"
                                ...
                                <tr>
                                    <th scope="col" class="ps-6 py-3 text-start">
                                        <label for="hs-at-with-checkboxes-main" class="flex">
                                            <input type="checkbox"
                                                class="shrink-0 border-gray-300 rounded text-green-20 focus:ring-green-20 disabled:opacity-50 disabled:pointer-events-none"
                                ...
                                <tr>
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-1.5">
                                            <a class="inline-flex items-center gap-x-1 text-sm text-green-20 decoration-2 hover:underline focus:outline-none focus:underline font-medium"
                                                href="#">
                                                Edit
                                            </a>
                                        </div>
                    ...
                    <!-- Footer -->
                    <div class="px-6 py-4 flex gap-3 items-center justify-between border-t border-gray-200">
                        <div>
                            <p class="text-sm text-gray-600">
