...
<body class="m-4">
    ...
    <x-primary-link text="Lorem, ipsum dolor sit amet consectetur Adipisicing elit. In, est." color="green"
        link="/" font="bold" />
    ...
    <x-primary-input placeholder="help" style="green" icon="{{ asset('assets/icons/user.svg') }}" class="w-52 mt-52" />
</body>
