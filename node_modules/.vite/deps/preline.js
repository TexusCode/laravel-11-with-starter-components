  ...
  "node_modules/preline/src/plugins/datatable/index.ts"() {
    ...
    HSDataTable = class _HSDataTable extends HSBasePlugin {
      ...
      pageEntitiesChange(evt) {
        this.onEntitiesChange(parseInt(evt.target.value));
      }
      pagingPrevClick() {
        this.onPrevClick();
      }
        ...
        if (pagingItems.length) {
          pagingItems.forEach((el) => {
            ...
            el.removeEventListener(
              "click",
              this.onSinglePagingClickListener.find((el2) => el2.id === counter).fn
            );
          });
...
var HSSelect = class _HSSelect extends HSBasePlugin {
  ...
  searchInput(evt) {
    if (this.apiUrl) this.remoteSearch(evt.target.value);
